                      ...
                      Padding(
                        ...
                        child: StreamBuilder<List<MapsRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<MapsRecord> columnMapsRecordList =
                                snapshot.data!;
                            return SingleChildScrollView(
                              child: Column(
                                ...
                                children: List.generate(
                                    columnMapsRecordList.length, (columnIndex) {
                                  final columnMapsRecord =
                                      columnMapsRecordList[columnIndex];
                                  return Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 15.0, 0.0, 0.0),
                                    child: FlipCard(
                                            ...
                                            Expanded(
                                              child: Padding(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Text(
                                                      'Difficulty: ${columnMapsRecord.difficulty}',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .bodyMedium,
